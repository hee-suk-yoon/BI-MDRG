...
#from open_flamingo.src.helpers import PerceiverResampler #added by HSY 10/6/23
...
#from open_flamingo.src.utils import apply_with_stopping_condition #added by HSY 10/6/23

import ipdb #added by HSY 10/6/23
...
class Flamingo(nn.Module):
    ...
    def forward(
        ...
        image_map: list = None, #added by HSY 10/6/23
    ):
        """
    ...
    def _encode_vision_x(self, vision_x: torch.Tensor):
        ...
        # added by HSY  10/7/23 shape of vision_x here : (# images, 1, 64, 1024)
